...
class ServiceController extends BaseController {
	...
	public function getAmphur() {
		...
		if(func_num_args() == 0) $amphurs = DB::table('amphur')->select('AMPHUR_ID', 'AMPHUR_NAME')->get(); 
	...
	public function getTambol() {
		...
		else $tambols = DB::table('district')->select('DISTRICT_ID', 'DISTRICT_NAME')->where('AMPHUR_ID', func_get_arg(0))->get();
