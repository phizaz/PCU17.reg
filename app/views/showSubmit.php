            ...
            <div class="register">
                <form id="register" action="" method="POST">                    
                    <div style="padding-left: 20px;">
                        <div class="just-left">
                            <h4>คำนำหน้า</h4>
                            <div id="name_prefix" name="name_prefix" type="text" class="input-text" style="width: 70px;">
                                <?php echo $name_prefix; ?>
                            </div>
                        </div>
                        <div class="just-left">
                            <h4>ชื่อ</h4>
                            <div id="name_first" name="name_first" class="input-text" type="text">
                                <?php echo $name_first; ?>
                            </div>
                        </div>
                        <div class="just-left just-last">
                            <h4>สกุล</h4>
                            <div id="name_last" name="name_last" class="input-text" type="text">
                                <?php echo $name_last; ?>
                            </div>
                        </div>
                        ...
                        <div class="just-left">
                            <h4>ชื่อเล่น</h4>
                            <div id="nickname" name="nickname" class="input-text" type="text" style="width: 80px">
                                <?php echo $nickname; ?>
                            </div>
                        </div>
                        <div class="just-left">
                            <h4>ศาสนา</h4>
                            <div id="religion" name="religion" class="input-text" type="text" style="width: 80px">
                                <?php echo $religion; ?>
                            </div>
                        </div>
                        <div class="just-left just-last">
                            <h4>เลขประจำตัวประชาชนไทย</h4>
                            <div id="national_id" name="national_id" class="input-text" type="text" style="width: 190px">
                        ...
                        <div class="group group-pink">
                            <div class="just-left">
                                ...
                                <div id="day" name="day" tabindex="1" class="input-text input-pink" style="width: 80px;">
                                    <?php echo $day; ?>
                                </div>
                            </div>
                            <div class="just-left">
                                <h4 class="pink">เดือนเกิด</h4>
                                <div id="month" name="month" tabindex="2" class="input-text input-pink" style="width: 190px;">
                                    <?php echo $month; ?>
                                </div>
                            </div>
                            <div class="just-left just-last">
                                <h4 class="pink">ปีเกิด</h4>
                                <div id="year" name="year" tabindex="3" class="input-text input-pink" style="width: 100px">
                                    <?php echo $year; ?>             
                                </div>
                            </div>
                            <div style="clear:both;"></div>
                        ...
                        <div class="just-left">
                            <h4>Facebook</h4>
                            <div id="facebook" name="facebook" class="input-text input-blue" type="text" style="width: 195px">
                                <?php echo $facebook; ?>
                            </div>
                        </div>
                        <div class="just-left just-last">
                            <h4>Email</h4>
                            <div id="email" name="email" class="input-text" type="text" style="width: 195px">
                                <?php echo $email; ?> 
                            </div>
                        </div>
                        ...
                        <div class="just-left">
                            <h4>หมู่เลือด</h4>
                            <div id="blood_group" name="blood_group"class="input-text" style="width: 70px">
                        ...
                        <div class="just-left">
                            ...
                            <div id="shirt_size" name="shirt_size"class="input-text" style="width: 70px">
                                <?php echo $shirt_size; ?>                         
                            </div>
                        </div>
                        <div class="just-left just-last">
                            <h4>อาหารที่แพ้</h4>
                            <div id="food_allergies" name="food_allergies" class="input-text" type="text" style="width: 250px">
                        ...
                        <div class="just-left">
                            <h4>แพ้ยา</h4>
                            <div id="drug" name="drug" class="input-text" type="text" style="width: 195px">
                                <?php echo $drug; ?>
                            </div>
                        </div>
                        <div class="just-left just-last">
                            <h4>โรคประจำตัว</h4>
                            <div id="disease" name="disease" class="input-text" type="text" style="width: 195px">
                                <?php echo $disease; ?>
                            </div>
                        </div>
                        <!-- Address Group -->
                        ...
                        <div class="group group-pink">
                            <div class="just-left">
                                ...
                                <div id="address" name="address" type="text" class="input-text input-pink" style="width: 70px">
                                    <?php echo $address; ?>
                                </div>
                            </div>
                            <div class="just-left">
                                <h4 class="pink">ถนน</h4>
                                <div id="road" name="road" type="text" class="input-text input-pink" style="width: 180px">
                                    <?php echo $road; ?>
                                </div>
                            </div>
                            <div class="just-left just-last">
                                <h4 class="pink">หมู่</h4>
                                <div id="moo" name="moo" type="text" class="input-text input-pink" style="width: 60px">
                                    <?php echo $moo; ?>
                                </div>
                            </div>
                            ...
                            <div class="just-left">
                                ...
                                <div id="province" name="province" id="province" class="input-text input-pink" style="width: 195px">
                                    <?php 
                            ...
                            <div class="just-left just-last">
                                ...
                                <div id="amphur" name="amphur" id="amphur" class="input-text input-pink" style="width: 195px">
                                    <?php 
                            ...
                            <div class="just-left">
                                ...
                                <div id="tambol" name="tambol" id="tambol" class="input-text input-pink" style="width: 195px">
                                    <?php 
                            ...
                            <div class="just-left just-last">
                                ...
                                <div id="zip_code" name="zip_code" type="text" class="input-text input-pink" style="width: 175px">                                
                                    <?php echo $zip_code; ?>
                                </div>
                            </div>
                        ...
                        <div class="just-left">
                            <h4>โทรศัพท์บ้าน</h4>
                            <div id="phone_home" name="phone_home" class="input-text" type="text" style="width: 100px">                
                                <?php echo $phone_home; ?>
                            </div>
                        </div>
                        <div class="just-left">
                            <h4>โทรศัพท์มือถือ</h4>
                            <div id="phone_mobile" name="phone_mobile" class="input-text" type="text" style="width: 100px">                
                                <?php echo $phone_mobile; ?>
                            </div>
                        </div>
                        <div class="just-left just-last">
                            <h4>รายได้ผู้ปกครองต่อเดือน</h4>
                            <div id="parent_income" name="parent_income"class="input-text" style="width: 170px">
                                <?php 
                        ...
                        <div class="group group-pink">
                            <div class="just-left">
                                ...
                                <div id="school_name" name="school_name" type="text" class="input-text input-pink" style="width: 230px">
                                    <?php echo $school_name; ?>
                                </div>
                            </div>
                            <div class="just-left just-last">
                                <h4 class="pink">จังหวัด</h4>
                                <div id="school_province" name="school_province" id="school_province" class="input-text input-pink" style="width: 140px">
                                     <?php 
                            ...
                            <div class="just-left">
                                <h4 class="pink">อำเภอ</h4>
                                <div id="school_amphur" name="school_amphur" id="school_amphur" class="input-text input-pink" style="width: 140px">
                                    <?php 
                            ...
                            <div class="just-left just-last">
                                ...
                                <div id="school_plan" name="school_plan"class="input-text input-pink" style="width: 140px">
                                    <?php 
                        ...
                        <div class="just-left just-last">
                            ...
                            <div id="method_arrive" name="method_arrive" class="input-text" type="text" style="width: 430px">   
                                <?php echo $method_arrive; ?>             
                            </div>
                        </div>
                        <div class="just-left just-last">
                            <h4>วิธีการเดินทางกลับ</h4>
                            <div id="method_depart" name="method_depart" class="input-text" type="text" style="width: 430px">                
                        ...
                        <div class="just-left">
                            ...
                            <div id="contact1_name" name="contact1_name" type="text" class="input-text" style="width: 190px">
                                <?php echo $contact1_name; ?>
                            </div>
                        </div>
                        <div class="just-left">
                            <h4>เบอร์โทรศัพท์</h4>
                            <div id="contact1_phone" name="contact1_phone" class="input-text" style="width: 100px">
                                <?php echo $contact1_phone; ?>
                            </div>
                        </div>
                        <div class="just-left just-last">
                            <h4>เป็น</h4>
                            <div id="contact1_relation" name="contact1_relation" class="input-text" style="width: 60px">
                        ...
                        <div class="just-left">
                            ...
                            <div id="contact2_name" name="contact2_name" type="text" class="input-text" style="width: 190px">
                                <?php echo $contact2_name; ?>
                            </div>
                        </div>
                        <div class="just-left">
                            <h4>เบอร์โทรศัพท์</h4>
                            <div id="contact2_phone" name="contact2_phone" class="input-text" style="width: 100px">
                                <?php echo $contact2_phone; ?>
                            </div>
                        </div>
                        <div class="just-left just-last">
                            <h4>เป็น</h4>
                            <div id="contact2_relation" name="contact2_relation" class="input-text" style="width: 60px">
                        ...
                        <div class="just-left">
                            ...
                            <div id="faculty1" name="faculty1" class="input-text" type="text" style="width: 195px">                
                                <?php echo $faculty1; ?>
                            </div>
                        </div>
                        <div class="just-left just-last">
                            <h4>สนใจเป็นอันดับสอง</h4>
                            <div id="faculty2" name="faculty2" class="input-text" type="text" style="width: 195px">                
                                <?php echo $faculty2; ?>
                            </div>
                        </div>
                        <div class="just-left">
                            <h4>สนใจเป็นอันดับสาม</h4>
                            <div id="faculty3" name="faculty3" class="input-text" type="text" style="width: 195px">  
                                <?php echo $faculty3; ?>
                            </div>              
                        </div>
                        <div class="just-left just-last">
                            <h4>สนใจเป็นอันดับสี่</h4>
                            <div id="faculty4" name="faculty4" class="input-text" type="text" style="width: 195px">                
                                <?php echo $faculty4; ?>
                            </div>
                        </div>
                        ...
                        <div class="just-left">
                            ...
                            <div id="course" name="course" class="input-text" style="width: 215px">
                                <?php 
